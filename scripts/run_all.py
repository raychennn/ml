#!/usr/bin/env python3
"""
Run All — Start Telegram bot + Scheduler + Flask web server in one process
============================================================================

Usage:
    python scripts/run_all.py
    python scripts/run_all.py --port 8080
...
def main():
    parser = argparse.ArgumentParser(description="Run bot + scheduler + web dashboard")
    parser.add_argument("--host", default=None)
    parser.add_argument("--port", type=int, default=None)
    parser.add_argument("--verbose", "-v", action="store_true")
    parser.add_argument("--no-scheduler", action="store_true", help="Disable automatic scanning")
